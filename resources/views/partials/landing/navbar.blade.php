<nav class="fixed top-0 left-0 w-full bg-white border-b border-emerald-200 backdrop-blur-md z-50">
    <div class="max-w-screen-xl mx-auto flex items-center justify-between p-3">
        ...
        <div class="flex items-center space-x-3">
            <a href="{{ route('login') }}" class="bg-[#40916C] text-white py-1 px-4 rounded hover:bg-[#2D6A4F] transition">
                Login
            </a>
            <a href="{{ route('register') }}" class="bg-[#40916C] text-white py-1 px-4 rounded hover:bg-[#2D6A4F] transition">
                Register
            </a>
        </div>
    </div>
